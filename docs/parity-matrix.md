...
| Whip, low damage + strong knockback + attack speed, downed state | PASS | `unit:CustodyServiceTest.whipUsesTheSameNonLethalCustodyFlow`; `gameTest:whipDamageRouting`; rank-gated armory item |
