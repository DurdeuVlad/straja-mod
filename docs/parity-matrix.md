...
| Whip, eight-frame impact-focused animation + low damage + strong knockback + attack speed, downed state | PASS | `unit:CustodyServiceTest.whipUsesTheSameNonLethalCustodyFlow`; `unit:WhipAssetTest`; `gameTest:whipDamageRouting`; rank-gated armory item |
